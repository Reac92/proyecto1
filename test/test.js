  ...
  describe('POST /api/meetings', function() {
    ...
    it('should create a new meetings and return it', function() {
      ...
      return request(app)
        .get('/api/meetings')
        .then((response) => {
          firstMeeting = response.body['0'];
        })
        .then(() => {
          updatedMeeting = Object.assign({}, firstMeeting, {note:'Already changed'});
          return request(app)
            .post('/api/meetings')
            .send(updatedMeeting)
            .expect(201);
        ...
        .then(() => {
          return request(app)
            ...
            .send({
              id: '56',
              time: '02:48',
              date: '2020-11-02T05:47:34.169Z',
              day: 'Mon Nov 02 2020',
              note: 'The last meeting added to db'
            })
            .expect(201);
        })
        .then((response) => response.body)
